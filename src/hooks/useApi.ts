  ...
  return {
    ...
    meal: {
      categories: {
        ...
        info: ({ categoryId, loader }) => {
          return new Promise((resolve, reject) => {
            http
              .request<{ id: string; name: string; ukrainianName: string; imageLink: string }>({
                method: 'GET',
        ...
        paginatedList: ({ loader, params }) => {
          return new Promise((resolve, reject) => {
            http
              .request<IPaginatedList<ICategory>>({
                method: 'GET',
          ...
          return new Promise((resolve, reject) => {
            http
              .request<{ id: string; name: string; ukrainianName: string; imageLink: string }[]>({
                ...
                paramsSerializer: {
                  serialize: (p) =>
                    qs.stringify(Object.fromEntries(Object.entries(p).filter(([k, v]) => v)), {
                      allowDots: true,
                    }),
                },
                headers,
    ...
    ingredients: {
      ...
      paginatedList: ({ loader, params }) => {
        return new Promise((resolve, reject) => {
          http
            .request<IPaginatedList<IIngredient>>({
              method: 'GET',
    ...
    recipes: {
      ...
      paginatedList: ({ loader, params }) => {
        return new Promise((resolve, reject) => {
          http
            .request<IPaginatedList<IRecipe>>({
              method: 'GET',
